    ...
    <div class="col-lg-8 col-12">
      ...
      <div class="row">
        <div class="col-sm-12 col-12">
          <div class="card">
            <h3 class="text-center card-header text-black">Nuevo Horario</h3>
            <div class="row">
              <form class="card-body" action="<?= base_url ?>schedule/save_send" method="POST" enctype="multipart/form-data">
                <div class="col-md-12">
